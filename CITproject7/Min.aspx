<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Min.aspx.cs" Inherits="CITproject7.Min" %>
  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
            ...
            <div class="subheading mb-5"> Calculate the Minimum Value for your Poker Planning</div>
            <h5> Add in commas between each number to calculate the Minimum Value</h5>
