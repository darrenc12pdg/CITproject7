<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Median.aspx.cs" Inherits="CITproject7.WebForm3" %>
  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
            ...
            <div class="subheading mb-5"> Calculate the Median Value for your Poker Planning</div>
            <h5> Add in commas between each number to calculate the Median</h5>
