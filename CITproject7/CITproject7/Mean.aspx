<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mean.aspx.cs" Inherits="CITproject7.Mean" %>
  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
            ...
            <div class="subheading mb-5"> Calculate the Mean Value for your Poker Planning</div>
            <h5> Add in commas between each number to calculate the Mean</h5>
            ...
            <asp:Label ID="Label_welcome" runat="server" Visible="false"/>
            <asp:Label ID="Label_ID" runat="server" Visible="false"/>  
