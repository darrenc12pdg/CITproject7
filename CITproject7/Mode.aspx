<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mode.aspx.cs" Inherits="CITproject7.Mode" %>
  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
            ...
            <div class="subheading mb-5"> Calculate the Mode Value for your Poker Planning</div>
            <h5> Add in commas between each number to calculate the Mode</h5>
